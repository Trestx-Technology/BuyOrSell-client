            ...
            {onSearchChange && (
              <div className="flex-1">
                <Input
                  ...
                  className={cn(
                    "pl-10 border-gray-200 dark:border-gray-700 h-11 shadow-sm",
            ...
            {onLocationChange && (
              <div className="flex-1">
                <SearchableDropdownInput
                  ...
                  className={cn(
                    "w-full h-11 border-gray-200 dark:border-gray-700 shadow-sm",
                    "bg-white dark:bg-gray-900 focus-visible:ring-purple/20 text-foreground",
                  )}
                />
              </div>
            )}
