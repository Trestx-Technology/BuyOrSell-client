...
export function TicketsList({ tickets, isLoading, emptyMessage = "You haven't created any support tickets yet." }: TicketsListProps) {
  ...
  if (!tickets || tickets.length === 0) {
    return (
      <div className="text-center py-12 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-dashed border-gray-300 dark:border-gray-800">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">{emptyMessage}</p>
      </div>
    );
  }
