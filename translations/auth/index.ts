...
export const authTranslations = createTranslationNamespace<AuthTranslations>({
  ...
  'nl-NL': {
    ...
    forgotPassword: {
      ...
      subtitle: 'Geen zorgen! Voer je e-mailadres in en we sturen je een link om je wachtwoord te resetten.',
      email: 'E-mail',
      ...
      emailSent: 'We hebben je een e-mail gestuurd met een link om je wachtwoord te resetten.',
    ...
    resetPassword: {
      ...
      successMessage: 'Je wachtwoord is succesvol gereset. Je kunt nu inloggen met je nieuwe wachtwoord.',
  ...
  'ar': {
    ...
    forgotPassword: {
      ...
      subtitle: 'لا تقلق! أدخل عنوان بريدك الإلكتروني وسنرسل لك رابط لإعادة تعيين كلمة المرور.',
      email: 'البريد الإلكتروني',
      ...
      emailSent: 'لقد أرسلنا لك بريد إلكتروني يحتوي على رابط لإعادة تعيين كلمة المرور.',
    ...
    resetPassword: {
      ...
      invalidLinkMessage: 'رابط إعادة تعيين كلمة المرور هذا غير صالح أو منتهي الصلاحية.',
