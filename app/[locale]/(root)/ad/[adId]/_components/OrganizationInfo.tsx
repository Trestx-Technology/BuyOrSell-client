...
import { Building2, FileText, Hash, ExternalLink, Flag } from "lucide-react";
...
export const OrganizationInfo: React.FC<OrganizationInfoProps> = ({ ad }) => {
  ...
  return (
    <>
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 p-4 shadow-sm relative block w-full hover:border-purple/50 transition-colors group">
      ...
      <ReportDialog
        ...
        reportedId={org._id}
        reportedType={org.type === "company" ? "company" : "organization"}
      />
    </>
  );
};
