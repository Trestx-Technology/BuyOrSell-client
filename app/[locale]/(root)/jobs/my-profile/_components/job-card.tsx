...
export default function JobCard({
  ...
  return (
    <div className="relative sm:w-[250px] bg-white dark:bg-zinc-900 border border-[#E2E2E2] dark:border-zinc-800 rounded-2xl p-4 shadow-[0px_2.67px_7.11px_rgba(48,150,137,0.08)] w-full flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="space-y-2 flex-1 gap-[21.33px] mb-4">
        ...
        <div className="flex flex-1 items-start gap-4">
          <div className="space-y-2 flex-1">
            ...
            <Typography variant="body-small" className="text-black dark:text-zinc-300 text-sm">
