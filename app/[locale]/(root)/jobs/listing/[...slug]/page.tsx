...
export default function JobsListingPage() {
  ...
  }, [currentCategory, searchQuery, locationQuery, filters, extraFields]);
  ...
  }, [currentCategory, currentPage, searchQuery, locationQuery, filters]);
          ...
          <div className="flex items-start gap-5">
            ...
            {/* Right Column - Job Detail View */}
                <div className="space-y-6 flex-1 min-w-0">
                  {selectedJobId && (
                    // If on mobile and a job is selected, we might want to ensure this takes full screen
                    // logic here relies on the sidebar being hidden on mobile when selectedJobId is true
                    // which is handled by className above.
                    <>
                      {isJobLoading ? (
                        <div className="text-center py-12">
