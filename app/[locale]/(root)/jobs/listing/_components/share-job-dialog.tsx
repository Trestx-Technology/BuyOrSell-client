...
export default function ShareJobDialog({ job, trigger }: ShareJobDialogProps) {
  ...
  return (
    <ResponsiveDialogDrawer
      ...
      title="Share Job"
      description="Share this job opportunity on your favorite platform"
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-2">
          <Input
            readOnly
            value={jobUrl}
            className="w-full rounded-md border bg-muted px-3 py-2 text-sm truncate"
          />
          <Button
            size="icon"
            variant="filled"
