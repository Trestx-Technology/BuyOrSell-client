...
const SavedOrganizationsPage = () => {
  ...
  const getStatusBadge = (status?: string) => {
    ...
    return (
      <div
        className={`px-2 py-1 ${config.bgColor} dark:bg-opacity-20 rounded-md`}
      >
        <Typography
      ...
      <div className="w-full px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-[#E5E5E5] dark:border-gray-800 p-12 text-center shadow-sm">
            ...
            >
              You haven&apos;t saved any organizations yet. Start exploring to
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <Typography
                          ...
                          className="text-base font-bold text-[#1D2939] dark:text-gray-100 line-clamp-2 group-hover:text-purple transition-colors"
                        >
