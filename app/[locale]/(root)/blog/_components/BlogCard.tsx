...
export const BlogCard = ({ blog, locale }: BlogCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-sm transition-all hover:shadow-xl border border-gray-100 dark:border-gray-700"
    >
