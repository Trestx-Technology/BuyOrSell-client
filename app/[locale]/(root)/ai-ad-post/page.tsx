...
import { AIAdPostContent } from "./_components/AIAdPostContent";
...
export async function generateMetadata(
  ...
  try {
    ...
    // Fallback metadata
    return {
      title: "AI Ad Post | BuyOrSell",
      description: "Create your ad instantly using AI-powered tools.",
    };
  }
}

export default function AIPromptPage() {
  return <AIAdPostContent />;
}
