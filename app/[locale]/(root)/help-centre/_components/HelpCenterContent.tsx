...
function StatCard({ label, value, icon }: { label: string, value: number, icon: React.ReactNode }) {
  return (
    <Card className="p-4 flex items-center justify-between border-gray-100 dark:border-gray-800 dark:bg-gray-900 shadow-sm">
      <div className="flex items-center gap-2">
        {icon}
        <H5 className="font-bold dark:text-gray-200">{label}</H5>
      </div>
      <H5 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{value}</H5>
    </Card>
  )
}
