...
import { MapViewContent } from "./_components/MapViewContent";
...
export async function generateMetadata(
  ...
  try {
    ...
    // Fallback
    return {
      title: "Map View | BuyOrSell",
      description: "Browse ads on the map to find deals near you.",
    };
  }
}
