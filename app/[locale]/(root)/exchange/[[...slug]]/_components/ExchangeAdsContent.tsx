              ...
              <div>
                ...
                <Typography variant="body-small" className="text-zinc-500 dark:text-zinc-400">
                  {t.categories.forSaleIn
                    .replace(
                      "{{category}}",
                      selectedCategory || categoryName || t.exchange.title,
                    )
                  ...
                  {ads.map((ad: any, index: number) => {
                    ...
                    return (
                      <React.Fragment key={ad._id}>
                        {showSponsored && (
                          <div className="w-full h-full min-h-[400px] relative rounded-xl overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
                            <BannerBySlug 
                              slug="exchange-page" 
