    ...
    return (
      <Container1080 className="min-h-[60vh] flex flex-col items-center justify-center p-4 space-y-4 text-center">
        ...
        <Typography variant="body-small" className="text-gray-500">
          We couldn't retrieve the status of your ad right now. However, if you
          didn't receive an error previously, your ad may still have been
    ...
    <Container1080 className="py-12 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 sm:p-12 text-center shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden">
          ...
          >
            {isApproved ? "Your Ad is Live!" : "Your Ad is Submitted!"}
          </Typography>
          ...
          >
            {isApproved
              ? "Great news! Your ad has been approved and is now visible to thousands of potential buyers on BuyOrSell."
              : "Thank you for posting! Our admin team is currently reviewing your ad. Once approved, it will be published and visible to buyers."}
          </Typography>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            {isApproved && (
              <Button
                ...
                onClick={() =>
                  router.push(localePath(`/ad/${ad.slug || ad._id}`))
                }
              >
                View Live Ad <Eye className="w-4 h-4 ml-2" />
              </Button>
            )}
            {!isApproved && (
              <Button
        ...
        <div className="mt-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 sm:p-6 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col sm:flex-row gap-6">
            {/* Image Placeholder */}
            <div className="w-full sm:w-48 aspect-[4/3] sm:aspect-square bg-gray-50 dark:bg-gray-800 rounded-xl overflow-hidden relative shrink-0 border border-gray-100 dark:border-gray-800 flex items-center justify-center">
              {adImage ? (
                <img
                  src={adImage}
                  alt="Ad Cover"
            ...
            <div className="flex-1 flex flex-col py-1">
              ...
              <div className="text-xl sm:text-2xl font-bold text-purple mb-4">
                {ad.price
                  ? `${ad.price.toLocaleString()} AED`
                  : "Price on request"}
                {ad.deal && ad.discountedPrice && (
