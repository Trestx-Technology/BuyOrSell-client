...
import DynamicFormContent from "./_components/DynamicFormContent";
...
export async function generateMetadata(
  ...
  try {
    ...
    // Fallback metadata
    return {
      title: "Enter Ad Details | BuyOrSell",
      description: "Provide details for your ad to post it on BuyOrSell.",
    };
  }
}
