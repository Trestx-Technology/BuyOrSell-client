...
import SelectJobCategoryContent from "./_components/SelectJobCategoryContent";
...
export async function generateMetadata(
  ...
  try {
    ...
    // Fallback metadata
    return {
      title: "Post a Job | BuyOrSell",
      description: "Recruit top talent by posting your job openings on BuyOrSell.",
    };
  }
}

export default function SelectJobCategoryPage() {
  return <SelectJobCategoryContent />;
}
