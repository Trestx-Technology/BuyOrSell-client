...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      ...
      description:
        "Discover amazing deals on cars, properties, furniture, electronics, jobs, and more. Buy, sell, and exchange items with verified sellers across the UAE. Find your perfect deal today!",
      keywords: [
        "buy sell exchange",
        "cars for sale",
        "properties UAE",
